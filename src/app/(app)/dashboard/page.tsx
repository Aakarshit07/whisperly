...
const dashboard = () => {
  ...
  const fetchAcceptMessage = useCallback(async () => {
    ...
    try {
      ...
      toast.error(
        axiosError.response?.data.message || "Error to fetch message settings"
      );
    } finally {
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      setValue("acceptMessages", !acceptMessages || false);
  ...
  const copyToClipboard = () => {
    ...
    toast("URL copied", {description: "Profile URL copied to clipboard"});
  }
